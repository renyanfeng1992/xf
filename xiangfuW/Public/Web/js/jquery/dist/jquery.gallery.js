            ...
            switch (dir) {
                case 'prev':
                    ...
                    if (this.support2d && this.supportTrans) {
                        ...
                        // current item moves left
                        this.$currentItm.addClass('dg-transition').animate(this._getCoordinates('left'), 400);
                        // right item moves to the center
                        this.$rightItm.addClass('dg-transition').animate(this._getCoordinates('center'), 400);
                        //next item moves to the right
                        if (this.$nextItm) {
                            // left item moves out
                            this.$leftItm.addClass('dg-transition').animate( this._getCoordinates('outleft') ,400);
                            this.$nextItm.addClass('dg-transition').animate(this._getCoordinates('right'), 400);
                        } else {
                            // left item moves left
                            this.$leftItm.addClass('dg-transition').animate(this._getCoordinates('right'), 400);
                        }
                    }
                    break;
                case 'next':
